        ...
        <div className='flex items-center min-h-screen bg-slate-100'>
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <a onClick={() => signIn('github')} href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
